...
import { TrendingUp, Zap, Target, Clock, ChevronLeft, ChevronRight, Timer, BarChart3 } from "lucide-react"
...
export function SidebarPanel({
  ...
  return (
    <>
          ...
          <>
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-2">
                Questions: html-model:latest → formatted with gpt-oss:120b-cloud
              </p>
            </div>
            ...
            <Button onClick={() => setIsMetricsOpen(true)} variant="outline" className="w-full flex items-center gap-2">
      ...
      <MetricsOverlay isOpen={isMetricsOpen} onClose={() => setIsMetricsOpen(false)} profile={profile} />
    </>
  )
}
