...
export const topics: Record<string, { name: string; description: string; subtopics: string[] }> = {
  arrays: {
    ...
    subtopics: ["array-basics", "two-pointers", "sliding-window", "sorting"],
  },
  strings: {
    name: "Strings",
    description: "String manipulation and pattern matching",
    subtopics: ["string-basics", "string-methods", "pattern-matching", "substring"],
  },
  "hash-table": {
    name: "Hash Table",
    description: "Hash maps and set operations",
    subtopics: ["hash-basics", "collision-handling", "set-operations"],
  },
  "linked-list": {
    name: "Linked List",
    description: "Linked list operations and algorithms",
    subtopics: ["list-basics", "traversal", "manipulation", "detection"],
  },
  stack: {
    name: "Stack",
    description: "Stack data structure and applications",
    subtopics: ["stack-basics", "parentheses-matching", "expression-evaluation"],
  },
  queue: {
    name: "Queue",
    description: "Queue data structure and BFS",
    subtopics: ["queue-basics", "bfs", "level-order-traversal"],
  },
  tree: {
    name: "Tree",
    description: "Binary trees and tree algorithms",
    subtopics: ["tree-basics", "traversal", "bst", "balanced-trees"],
  },
  graph: {
    name: "Graph",
    description: "Graph algorithms and traversal",
    subtopics: ["graph-basics", "dfs", "bfs", "shortest-path"],
  },
  "dynamic-programming": {
    name: "Dynamic Programming",
    description: "DP algorithms and optimization",
    subtopics: ["memoization", "tabulation", "optimization", "state-transitions"],
  },
  recursion: {
    name: "Recursion",
    description: "Recursive algorithms and backtracking",
    subtopics: ["base-cases", "backtracking", "divide-and-conquer"],
  },
  sorting: {
    name: "Sorting",
  ...
  searching: {
    ...
    subtopics: ["linear-search", "binary-search", "dfs", "bfs"],
  },
  math: {
    name: "Math",
    description: "Mathematical algorithms and number theory",
    subtopics: ["number-theory", "combinatorics", "geometry"],
  },
  "bit-manipulation": {
    name: "Bit Manipulation",
    description: "Bitwise operations and techniques",
    subtopics: ["bitwise-ops", "bit-patterns", "optimization"],
  },
  greedy: {
    name: "Greedy",
    description: "Greedy algorithms and optimization",
    subtopics: ["greedy-choice", "activity-selection", "huffman-coding"],
  },
}
...
export const predefinedLearningPaths = [
  ...
  },
  {
    ...
    topics: ["linked-list", "stack", "queue", "tree"],
    isCustom: false,
    estimatedHours: 16,
  },
  {
    ...
    description: "Explore dynamic programming, graphs, and optimization",
    topics: ["graph", "dynamic-programming", "recursion", "greedy"],
    isCustom: false,
    estimatedHours: 20,
  },
  {
    ...
    description: "Comprehensive algorithm and data structure learning path",
    topics: [
      "arrays",
      "strings",
      "hash-table",
